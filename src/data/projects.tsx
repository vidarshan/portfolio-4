export const projects = [
  ...
  },
  {
    ...
    name: "Techstop",
    description:
      "A sleek e-commerce platform for a tech gadget store, designed for effortless navigation and clarity. Features include advanced search filters for easy product discovery, a convenient shopping cart, and PayPal integration for smooth transactions. The perfect online destination for tech enthusiasts seeking a seamless shopping experience!",
    image:
...
export const testimonials = [
  {
    ...
    avatar:
      "https://res.cloudinary.com/dury4s2jk/image/upload/v1684941524/hasith_droy9i.webp",
    description:
  ...
  },
  {
    ...
    avatar:
      "https://res.cloudinary.com/dury4s2jk/image/upload/v1684941524/beta_irlpid.webp",
    description:
...
export const projectsArchive = [
  {
    ...
    image:
      "https://res.cloudinary.com/dury4s2jk/image/upload/v1685977249/findmystay_puw1kl.webp",
